...
class UpdateBookRequest extends FormRequest
{
  ...
  {
    $this->merge([
      'year_published' => $this->year_published ? date("Y-m-d", strtotime($this->year_published)) : null,
    ]);
  }
  ...
  public function validatedWithCasts()
  {
    if (!$this->hasFile('book_image')) {
      ...
      File::delete(storage_path('app/public/book-images/' . $this->book->book_image));
      $validatedData['book_image'] = 'book_cover.jpeg';
    ...
    $imageFile->storeAs('public/book-images', $imageName);
  ...
  {
    if (auth()->user()->id !== $this->book->user_id) {
      throw new HttpResponseException(response()->json([
        'success'     => false,
        'status_code' => 403,
  ...
  public function messages()
  {
    return [
      ...
      'book_image.mimes'           => 'A book image must be a file of type: png, jpeg, jpg',
